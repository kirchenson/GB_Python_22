...
r = lambda a, b: randint(a, b)
a, b, c, d = r(0,4), r(0,4),r(0,4),r(0,4)
count = 0
...
a_1, b_1 = int(input('Введите строку для первого корабля(1-5) : ')), int(
    input('Введите столбец для первого корабля(1-5) : '))
count_1 = 0
